  ...
  <div class="container mt-4">
    <div class="d-flex flex-column align-items-center">
          ...
          <div class="card-body text-center">
            <div class="input-group input-group-lg">
              <input
                ...
                ref="searchQuery"
              />
              <button class="btn btn-sm btn-outline-info" title="Pick a random attendee" @click="chooseReandom">
                <font-awesome-icon icon="random"></font-awesome-icon>
              </button>
              <button class="btn btn-sm btn-outline-info" title="Reset Search" @click="resetQuery">
      ...
      <div class="col-8 col-sm-6 col-md-4 col-lg-3 mb-2 p-0 px-1" v-for="item in filteredAttendees" :key="item.id">
        <div class="card">
          <div class="card-body px-3 py-2 d-flex align-items-center justify-content-between">
