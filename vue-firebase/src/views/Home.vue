  ...
  <div class="mt-3">
    <div class="text-secondary text-center">
      <div v-if="user" class="text-center">
        Welcome back <span class="font-wight-bold text-info">{{ user.disaplayName || user.email }}</span
    ...
    <div class="container text-center">
      <div class="row justify-content-center">
        <div class="col-10 col-md-10 col-lg-8 col-xl-7">
          ...
          <p class="lead">
            This simple app creates meetings, allows people to check in, and picks random users to award giveaways. It's
            a good example of a Single Page Application which includes connection to a database and routing. It's a
          ...
          <router-link class="btn btn-outline-primary me-2" to="/login" v-if="!user">Log In</router-link>
